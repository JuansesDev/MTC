...
dotnet publish MTC/MTC.csproj -c Release -r linux-x64 --self-contained true -p:PublishSingleFile=true -p:PublishTrimmed=true -o $OUTPUT_DIR/linux-x64
...
dotnet publish MTC/MTC.csproj -c Release -r win-x64 --self-contained true -p:PublishSingleFile=true -p:PublishTrimmed=true -o $OUTPUT_DIR/win-x64
...
dotnet publish MTC/MTC.csproj -c Release -r osx-x64 --self-contained true -p:PublishSingleFile=true -p:PublishTrimmed=true -o $OUTPUT_DIR/osx-x64
